...
public class Proyek_Siakad {
    ...
    public static void delAllData() {
        ...
        if (konf.charAt(0) == 'Y' || konf.charAt(0) == 'y') {
            dataMahasiswa.clear();
            jumlahData= dataMahasiswa.size();
            System.out.println("Succesfull Delete All Data");
        } else {
    ...
    public static void uas() {
        if (jumlahData==0){
            ...
            System.out.println("Data Berhasil Diurutkan. Silahkan tampilkan data.");
        }
